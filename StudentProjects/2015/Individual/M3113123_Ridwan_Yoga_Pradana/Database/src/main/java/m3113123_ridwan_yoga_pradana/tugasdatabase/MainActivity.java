package m3113123_ridwan_yoga_pradana.tugasdatabase;
...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonTambahBiodata = (Button) findViewById(R.id.buttonTambahData);
        ...
        viewHeaderAction.setText("Pilihan");
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.buttonTambahData) {

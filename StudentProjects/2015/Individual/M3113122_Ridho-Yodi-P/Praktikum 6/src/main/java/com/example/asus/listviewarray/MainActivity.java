package com.example.asus.listviewarray;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayList<String> ray = new ArrayList<String>();
        final ArrayAdapter<String> dapter;
        dapter = new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,ray);
        LiView.setAdapter(dapter);

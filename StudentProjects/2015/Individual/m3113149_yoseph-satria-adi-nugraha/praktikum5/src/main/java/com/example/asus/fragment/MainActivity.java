...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* FragmentManager fm = getSupportFragmentManager();
        ...
        transaction.add(R.id.LayoutFrag, startFragment);
        transaction.commit();*/
    }
   ...
   /* public void onSelectFragment(View view){
        ...
        if (view==findViewById(R.id.FragStart)){
            newFragment = new Start();
        }else if (view==findViewById(R.id.FragGroup)){
            newFragment = new Group();
        }else if (view==findViewById(R.id.FragIdentitas)){
            newFragment = new Identitas();
        }else {
            newFragment = new Start();
        }

        FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
        transaction.replace(R.id.LayoutFrag, newFragment);

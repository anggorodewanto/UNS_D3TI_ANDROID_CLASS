package praktikum.github.tugasdatabase;
...
/**
 * Created by TOSHIBA on 26/11/2015.
 */
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    private static final String query_buat_tabel_biodata_pemain =
            "CREATE TABLE IF NOT EXISTS tabel_biodata(id_biodata INTEGER" +
                    "PRIMARY KEY AUTOINCREMENT, nama TEXT,alamat TEXT)";
    private static final String query_hapus_tabel_biodata_pemain =
            "DROP TABLE IF EXISTS query_buat_tabel_biodata_pemain";

package com.nilawati.praktikum_11;
...
/**
 * Created by Rizki Nilawati on 03/12/2015.
 */
public class SQLiteHelper extends SQLiteOpenHelper {

    private  static final String database_name = "db_player.db";
    private static final int database_version = 1;
    private static final String query_for_create_player_table = "CREATE TABLE IF NOT EXISTS " +
            "tabel_biodata(id_biodata INTEGER PRIMARY KEY AUTOINCREMENT, nama TEXT,alamat TEXT)";
    private static final String query_for_drop_player_table = "DROP TABLE IF EXISTS query_for_create_player_table";

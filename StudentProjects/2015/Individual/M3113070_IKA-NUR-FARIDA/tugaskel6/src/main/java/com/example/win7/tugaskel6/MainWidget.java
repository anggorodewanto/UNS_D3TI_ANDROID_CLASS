...
public class MainWidget extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager,
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            Intent intent = new Intent(context, Configurasi.class);
            ...
            // And the label
            String userName = Configurasi.loadUserName(context, appWidgetId);
            if (userName != null) {
    ...
    public static PendingIntent makeControlPendingIntent(Context context,
        ...
        Intent active = new Intent(context, Jam.class);
    ...
    public void onDisabled(Context context) {
        ...
        context.stopService(new Intent(context, Jam.class));
